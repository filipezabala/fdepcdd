...
```{exercise}
Assista aos vídeos [The Bayesian Trap](https://www.youtube.com/watch?v=R13BD8qKeTg&vl=en) e [Bayes theorem](https://www.youtube.com/watch?v=HZGCoVF3YvM). Lembre que você pode ativar a legenda (botão CC) e alterar a língua nas configurações (ícone de engrenagem > legendas). $\\$
```
